...
pub struct FuehrerstandsAnzeigen {
    #[zusi(id = 0x0001)]
    /// Führerstands-IDs gemäß Tabelle aus Dokumentation.
...
pub struct Programmdaten {
    #[zusi(id = 0x0001)]
    /// Programm-IDs gemäß Tabelle aus Dokumentation.
    pub anzeigen: Vec<u16>,
}
...
pub struct AckNeededData {
    #[zusi(id = 0x0001)]
    /// Der Befehl wurde akzeptiert, wenn das Byte auf `00` steht.
    /// Wird der Befehl nicht akzeptiert, wird stattdessen ein anderes Byte gesendet.
    pub error_code: u8,
}
...
pub struct DataFtd {
    ...
    //
    // #[zusi(id = 0x0016)]
    // /// Single: Nicht sinnvoll zu verwenden
    //d3DFenster: Option<f32>,
    #[zusi(id = 0x0017)]
    /// Single: m/s
...
pub struct StatusNotbremssystem {
    #[zusi(id = 0x0001)]
    /// Bauart des Notbremssystems
    pub bauart: Option<String>,

    #[zusi(id = 0x0002)]
    /// Status des Notbremssystems
    ///
    /// - 0: NBÜ aus
    /// - 1: NBÜ bereit
    /// - 2: Notbremse gezogen
    /// - 3: Notbremse wirkt (NBÜ bereit)
    /// - 4: NBÜ durch Lokführer aktiviert
    /// - 5: Notbremse wirkt (NBÜ aus)
    /// - 6: Notbremse ist daueraktiviert, Notbremse ohne jede Wirkung
    pub status_notbremssystem: Option<u8>,

    #[zusi(id = 0x0003)]
    #[deprecated(note = "Please use lm_system_bereit instead")]
    /// Statusmelder _"System bereit"_
    ///
    /// 1: an
    pub system_bereit: Option<u8>,

    #[zusi(id = 0x0004)]
    #[deprecated(note = "Please use lm_notbremsung instead")]
    /// Statusmelder _"Notbremsung"_
    ///
    /// 1: an
    pub notbremsung: Option<u8>,
    ...
    #[zusi(id = 0x0006)]
    /// Status Melder _"System bereit"_:
    ///
    /// - 0: aus
    /// - 1: an
    /// - 2: blinkend
...
pub struct StatusSifa {
    ...
    #[zusi(id = 0x0007)]
    /// Wert des Weglängenmessers
    pub wert_weglaengenmesser: Option<f32>,
}
...
pub struct StatusZugbeeinflussung {
    #[zusi(id = 0x0001)]
    /// Bauart des Zugbeeinflussungssystems
    pub bauart: Option<String>,
...
pub struct IndusiBetriebsdaten {
    ...
    ///
    /// - 1: Ausgeschaltet
    /// - 2: abgeschaltet/gestört (1000Hz blinkt)
    /// - 3: Hauptluftleitung unter 2,2 bar (1000Hz blinkt)
    ...
    #[zusi(id = 0x0003)]
    /// Grund der Zwangsbremsung
    ///
    /// - 0: keine Zwangsbremsung, sonst Zwansbremsung aktiv
    /// - 1: Wachsam
    /// - 2: 1000Hz
    /// - 3: 500Hz
    /// - 4: 2000Hz
    ...
    #[zusi(id = 0x0004)]
    /// Grund der Zwangsbremsung als Text
    pub zwangsbremsungsgrund_string: Option<String>,

    #[deprecated(note = "use lm_1000hz instead")]
    #[zusi(id = 0x0005)]
    pub lm_1000hz_bool: Option<u8>,

    #[zusi(id = 0x0006)]
    pub lm_u_bool: Option<u8>,

    #[zusi(id = 0x0007)]
    pub lm_m_bool: Option<u8>,

    #[zusi(id = 0x0008)]
    pub lm_o_bool: Option<u8>,
    ...
    pub erfolgt_1000hz: Option<u8>,

    #[zusi(id = 0x002D)]
    /// 500Hz beeinflussung erfolgt = 1
    pub erfolgt_500hz: Option<u8>,

    #[zusi(id = 0x002E)]
    /// 2000Hz beeinflussung erfolgt = 1
    pub erfolgt_2000hz: Option<u8>,

    #[zusi(id = 0x002F)]
    /// Status 1000Hz-Melder:
    ///
    /// - 0: aus
    /// - 1: an
    /// - 2: blinkend
